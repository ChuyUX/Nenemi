...
<div class="wl-modal wl-modal--sm">
    ...
    <form method="post" action="<?= $routeUrl; ?>" data-wishlist-ajax>
                                        ...
                                        <span class="wl-form__checkbox-field">
                                            <?php if($isMove) :?>
                                                <input type="radio" required value="<?php echo $wishlist['wishlist_key'] ?>" name="wishlist_move_to"
                                                    <?= premmerce_wishlist()->isProductInWishlist($productId, $wishlist['wishlist_key']) ? 'disabled' : ''?>
                                                >
                                            <?php else : ?>
                                                <?php $checked = $wishlist['default'] ? 'checked':''; ?>
                                                <input type="radio" <?= $checked; ?> value="<?php echo $wishlist['ID'] ?>" name="wishlist_id">
                                            <?php endif; ?>
                                        </span>
                                        <span class="wl-form__checkbox-inner">
                                            <span class="wl-form__checkbox-title">
                        ...
                        <div class="wl-form__field" data-wishlist-new-scope>
                            ...
                            <div class="wl-form__inner">
                                ...
                                <span class="wl-form__checkbox-field">
                                    ...
                                    <span class="wl-form__checkbox-inner">
                                    <span class="wl-form__checkbox-title">
                                        <input class="form-control" type="text" name="wishlist_name" data-wishlist-new-input>
                                    </span>
                                </span>
                                </label>
                            </div>
        ...
        <div class="wl-modal__footer">
            <div class="wl-modal__footer-row">
                ...
                <div class="wl-modal__footer-btn">
                    ...
                    <?php if($success) :?>
                        <a class="button alt" href="<?= site_url('wishlist'); ?>"
        ...
        <?php if($success) :?>
            <div hidden data-ajax-grab="wishlist-link--<?= $productId; ?>">
                <?php $premmerce_wishlist_frontend->renderWishlistBtn($productId); ?>
            </div>
        <?php endif; ?>

        <?php if($isMove): ?>
            <input type="hidden" name="wishlist_key" value="<?= premmerce_wishlist()->getWishlistKeyByProductId($productId); ?>">
        ...
        <?php else: ?>
            ...
            <input type="hidden" name="wishlist_product_id" value="<?= $productId; ?>">
        <?php endif; ?>
